...
--
-- Host: 127.0.0.1    Database: auth-db
-- ------------------------------------------------------
...
--
-- Current Database: `auth-db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `auth-db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `auth` VALUES (1,'grubio','$2a$10$6D9As.3A6oC.PzW/I8b41uvqlIiw4B1jBfLhpymTfSJlnXkz6Q8gm','ROLE_ADMIN',1),(2,'jbueno','$2a$10$6D9As.3A6oC.PzW/I8b41uvqlIiw4B1jBfLhpymTfSJlnXkz6Q8gm','ROLE_USER',1),(3,'teste','$2a$10$6D9As.3A6oC.PzW/I8b41uvqlIiw4B1jBfLhpymTfSJlnXkz6Q8gm','ROLE_USER',1);
/*!40000 ALTER TABLE `auth` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'auth-db'
--

--
-- Dumping routines for database 'auth-db'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-03-15 22:39:06',NULL),('diagnostics.include_raw','OFF','2021-03-15 22:39:06',NULL),('ps_thread_trx_info.max_length','65535','2021-03-15 22:39:06',NULL),('statement_performance_analyzer.limit','100','2021-03-15 22:39:06',NULL),('statement_performance_analyzer.view',NULL,'2021-03-15 22:39:06',NULL),('statement_truncate_len','64','2021-03-15 22:39:06',NULL);
...
-- Dump completed on 2021-04-08 23:20:32
